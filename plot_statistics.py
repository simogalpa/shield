...
onlyfiles = [f for f in os.listdir("Datas") if os.path.isfile(os.path.join("Datas" , f))]

datafiles = dict()
print("Select the data you want to analize")
for i in range(len(onlyfiles)):
    datafiles[str(i)] = onlyfiles[i]
    print("\t {} : {}".format(i, datafiles[str(i)]))
in_num = input("--->")

filename= datafiles[in_num]
